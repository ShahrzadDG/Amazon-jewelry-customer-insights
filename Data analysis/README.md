...
**overall brand satisfaction score**, **brand quality gap**, **market structure by 
price segment**, **value-for-money score**, **brand stability over time**, **problem 
review rate**, **complaint distribution across segments**, **brand health by complaint 
frequency**, and **complaint severity** (quantified via regression coefficients). 
...
- Analyzed market structure:
    ...
    - Compared average rating and popularity (review counts) across price segments.
        ...
        - Cheap products have the highest number of ratings, which is due to higher customer engagement and volume. Luxury products remain significantly less reviewed but show gradual growth in recent years, maybe due to Amazon's expansion into more categories, or sellers listing more luxury items. This may reflect growing availability of or interest in higher end jewelry on the platform.
